import { Calendar, DollarSign, Users, ShoppingBag, TrendingUp, ArrowUpRight, ArrowDownRight } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Real-time insights on your business performance</p>
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="h-64 flex items-end justify-between gap-2 sm:gap-4 px-2">
                        ...
                        {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
                            <div key={i} className="flex-1 flex flex-col justify-end group cursor-pointer">
                                <div className="relative w-full bg-slate-100 rounded-t-lg transition-all duration-300 group-hover:bg-slate-200 overflow-hidden" style={{ height: '100%' }}>
                                    <div
                ...
                <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="w-48 h-48 rounded-full border-[1.5rem] border-slate-100 relative flex items-center justify-center">
                            ...
                            <div className="text-center">
                                <span className="block text-2xl font-bold text-slate-900">4.2k</span>
                    ...
                    <div className="space-y-4">
                        <CategoryLegend label="Electronics" value="45%" color="bg-blue-500" />
                        <CategoryLegend label="Home & Kitchen" value="30%" color="bg-purple-500" />
                        <CategoryLegend label="Fashion" value="15%" color="bg-emerald-500" />
...
function StatCard({ title, value, change, icon: Icon, positive, color }) {
    return (
        <div className="bg-white border border-slate-100 rounded-2xl p-6 hover:shadow-md transition-all cursor-default group shadow-sm">
            <div className="flex justify-between items-start mb-4">
                <div className={`p-3 rounded-xl ${color} opacity-90 group-hover:opacity-100 transition-opacity`}>
                    <Icon className="w-6 h-6" />
                </div>
                <div className={`flex items-center text-sm font-medium ${positive ? 'text-emerald-600' : 'text-rose-600'}`}>
...
function CategoryLegend({ label, value, color }) {
    return (
